...
public class RoboSubscriber {
  ...
  public static void main(String[] args)
  {
    ...
    RoboEvents events = new RoboEvents();
    ...
    RoboCallback mycallback = new RoboCallback();
    
    // create a message instance
    RoboMsg hellomsg = new RoboMsg(appDomain,"motion_speed");
